...
export const INITIAL_MOCK_SESSIONS: LibrarySession[] = [
  ...
  { id: 'SES-2026-1006', studentId: 'STU-2026-0331', studentName: 'Sofia Alvarez', department: 'Civil Engineering', seatNumber: 'B01', section: 'B', entryTime: '2026-09-12T08:50:00', status: 'active' },
  { id: 'SES-2026-1007', studentId: 'STU-2026-0377', studentName: 'Devon Vance', department: 'Computer Science', seatNumber: 'B03', section: 'B', entryTime: '2026-09-12T09:05:00', status: 'active' },
  { id: 'SES-2026-1008', studentId: 'STU-2026-0412', studentName: 'Maya Patel', department: 'Electrical Engineering', seatNumber: 'B06', section: 'B', entryTime: '2026-09-12T09:30:00', status: 'active' },
  { id: 'SES-2026-1009', studentId: 'STU-2026-0450', studentName: 'Julian Mercer', department: 'Mechanical Engineering', seatNumber: 'B09', section: 'B', entryTime: '2026-09-12T10:10:00', status: 'active' },
  { id: 'SES-2026-1010', studentId: 'STU-2026-0489', studentName: 'Zainab Qureshi', department: 'Information Technology', seatNumber: 'B12', section: 'B', entryTime: '2026-09-12T10:30:00', status: 'active' },
  { id: 'SES-2026-1011', studentId: 'STU-2026-0521', studentName: 'Lucas Becker', department: 'Civil Engineering', seatNumber: 'C02', section: 'C', entryTime: '2026-09-12T08:25:00', status: 'active' },
  { id: 'SES-2026-1012', studentId: 'STU-2026-0564', studentName: 'Ananya Roy', department: 'Business Administration', seatNumber: 'C05', section: 'C', entryTime: '2026-09-12T09:55:00', status: 'active' },
